...
import type { ProjectSummary } from "../src/shared/protocol.js";
...
describe("HttpWorkbenchStore", () => {
  ...
  beforeEach(async () => {
    ...
    vi.resetModules();
    const module = await import("./httpWorkbench.js");
  ...
  test("keeps project test assets under application data and nests environments", async () => {
    const { HttpWorkbenchStore } = await import("./httpWorkbench.js");
