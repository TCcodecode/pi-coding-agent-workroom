...
import { PiHost, type PiRuntimeLike } from "./piHost.js";

vi.mock("./sessionCatalog.js", async (importOriginal) => {
  const actual = await importOriginal<typeof import("./sessionCatalog.js")>();
  return {
    ...actual,
