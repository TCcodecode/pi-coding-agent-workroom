...
export interface CompanionInvokerOptions {
...
export function createCompanionInvoker(host: CompanionHostFacade, options: CompanionInvokerOptions = {}) {
  const handlers: Record<string, (args: unknown[]) => Promise<unknown>> = {
    ...
    getGitBranch: async (args) => options.getGitBranch?.(String(args[0] ?? "")),
