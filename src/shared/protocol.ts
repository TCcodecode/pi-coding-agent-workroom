...
export type PiEvent =
  ...
  | PiEventBase<"user_message_created", { messageId: string; content: string; entryId?: string }>
...
export interface PiApi {
  ...
  /**
   * Undo the in-process last turn: restore files mutated this turn, then
   * navigate the session tree to that user prompt (Pi `/tree`).
   */
  rewindLastTurn(
